...
export async function getRandomImagesService(count) {
    await connect();
...
export async function getImagesByTagService(query) {
...
export async function deleteDuplicatesFromDBService() {
...
export async function saveImagesService() {
    await connect();
...
export async function getImagesByTagFromDBService(query) {
    await connect();
